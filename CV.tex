...
\centerline{\normalsize{求职意向：AI 产品经理实习生（AI Coding / 开发者工具方向）}} 
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{成果与产品认知}：验证了“自动化数据采集—知识库构建—本地小模型专属微调”闭环的可行性，将原本依赖算法工程师多环节手动操作的领域模型定制流程转化为一键式自动化工作流，显著降低使用门槛；全程以 AI 辅助编码方式独立完成原型开发与调试，作为重度用户形成了对 AI Coding 协作模式、能力边界及开发者工具链痛点的系统认知。
\end{itemize}
...
\begin{itemize}[nosep]
    \item \textbf{AI Coding 与开发者工具：} 长期高频使用 AI 辅助编码工具独立完成 4 个完整项目（智能体平台、移动端智能体、图像微调、工业算法），熟练掌握“需求拆解—代码生成—幻觉排查—验证交付”全流程；对开发者工具链与软件研发全生命周期（需求、开发、测试、部署）有一手实践，对 AI Coding 产品的典型失效模式、交互流程与用户痛点有系统总结
